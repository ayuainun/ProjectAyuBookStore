      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            <div class="content">
               <span>ORDER NOW..</span>
               <h3>Perahu Kertas</h3>
               <a href="book.php" class="btn">view our novel</a>
            </div>
            <div class="image">
...
<section class="category">
  ...
  <h1 class="title">novel category</h1>

   <div class="box-container">

      <a href="category.php?category=romantic" class="box">
         <img src="images/romantic.png" alt="">
         <h3>romantic</h3>
      </a>

      <a href="category.php?category=horror" class="box">
         <img src="images/horror.png" alt="">
         <h3>horror</h3>
      </a>

      <a href="category.php?category=comedy" class="box">
...
<section class="products">
   ...
   <div class="more-btn">
      <a href="book.php" class="btn">view all</a>
   </div>
